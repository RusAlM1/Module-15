# myFile = open(r'C:\Users\Руслан\PycharmProjects\Module 15\venv\filename2.txt', 'rt') #абсолютный путь

# росплатформенный вызов файла с абсолютным или относительным путем
# import os
#
